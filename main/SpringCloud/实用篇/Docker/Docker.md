...
docker run --name mysql -d -p 3306:3306 -e MYSQL_ROOT_PASSWORD=132125 mysql:8.0.26
docker run --name LGQS -p 8080:8080 --link mysql:mymysql -d lgqs
```
...
sed -i -e 's#Welcome to nginx#你好，CuriT#g' -e 's#<head>#<head><meta charset="utf-8">#g' index.html
